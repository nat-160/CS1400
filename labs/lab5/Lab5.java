...
public class Lab5 {
  public static void main(String[] args) {
    ...
    Student student1 = new Student(sFirstname, sLastname, sBroncoId, -1.00);
    ...
    // Produce a report with the information below by using a helper method. The specification is
    // provided in the UML class diagram
    System.out.println("\n========== Program Submission Detail ==========");
    System.out.println(
        String.format("%-12s: %-10s", "Student", program1.getAuthor().getFullName()));
    System.out.println(
        String.format("%-12s: %-10s", "Bronco ID", program1.getAuthor().getBroncoId()));
    System.out.println(
        String.format("%-12s: %-10s", "Grade", "" + program1.getAuthor().getGrade()));
    System.out.println("");
